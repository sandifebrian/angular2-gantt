...
@Component({
    ...
    </div><div class="gantt_activity" (window:resize)="onResize($event)" [ngStyle]="{ 'height': ganttActivityHeight, 'width': ganttActivityWidth - 5 + 'px' }"> <!--, 'width': ganttActivityWidth - 18 + 'px'-->
    ...
    //     .gantt_activity:hover {
    //         overflow-x: scroll;
    //         padding-bottom: 1px;
    //    }

       .gantt_activity::-webkit-scrollbar, .gantt_vertical_scroll::-webkit-scrollbar {
            width: 9px;
            height: 9px;
        }

        .gantt_activity::-webkit-scrollbar-track {
            display: none;
        }

        .gantt_activity::-webkit-scrollbar-thumb, .gantt_vertical_scroll::-webkit-scrollbar-thumb {
            border-radius: 1px;
            background: #bebebe;
        }
...
export class GanttActivityComponent implements OnInit, DoCheck {
    ...
    public gridColumns: any[] = [
        { name: '', left: 0, width: 10 }, // { name: '', left: 0, width: 16 },
        { name: 'Task', left: 20, width: 200 }, // { name: 'Task', left: 20, width: 330 },
    ...
    ngOnInit() {
        ...
        console.log(this.ganttService.TIME_SCALE, this.ganttService.TASK_CACHE, this.dimensions);
    }
